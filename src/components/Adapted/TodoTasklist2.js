        ...
        {todos.length > 0 ? <Fragment>
            ...
            <div key={todotask.id} className="site-card-wrapper">               
                ...
                <Link to={`/edit/${todotask.id}`}>
                                <button style={{ objectFit: 'scale-down'}} onClick={() => editTodo(todotask.id)} className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold mr-3 py-2 px-2 rounded-full inline-flex items-center">
                ...
                <Card.Grid style={gridStyle}>    
                 ...
                 <button style={{ objectFit: 'scale-down'}} onClick={() => togglecompleteTodo(todotask.id)} className="block bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-2 rounded-full inline-flex items-center">
                        <FontAwesomeIcon icon={faToggleOn} />
                     </button> 
                    
                    </Card.Grid>    
                <Card.Grid style={gridStyle}>
                <button style={{ objectFit: 'scale-down'}} onClick={() => removeTodo(todotask.id)} className="block bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-2 rounded-full inline-flex items-center">
